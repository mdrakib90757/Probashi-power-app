...
class MshipPurchasesScreen extends StatefulWidget {
  final PackageListModel?selectPackage;
  const MshipPurchasesScreen({super.key, this.selectPackage});

  @override
  State<MshipPurchasesScreen> createState() => _MshipPurchasesScreenState();
}

class _MshipPurchasesScreenState extends State<MshipPurchasesScreen> {
