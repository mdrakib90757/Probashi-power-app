...
class JseackerPurechaseScreen extends StatefulWidget {
  final PackageListModel?selectPackage;
  const JseackerPurechaseScreen({super.key, this.selectPackage});

  @override
  State<JseackerPurechaseScreen> createState() => _JseackerPurechaseScreenState();
}

class _JseackerPurechaseScreenState extends State<JseackerPurechaseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if(package==null){
      return Center(child: Text("কোনো প্যাকেজ ডেটা পাওয়া যায়নি"),);
    }
