...
class AgentPurchaseScreen extends StatefulWidget {
  final PackageListModel?selectPackage;
  const AgentPurchaseScreen({super.key, this.selectPackage});

  @override
  State<AgentPurchaseScreen> createState() => _AgentPurchaseScreenState();
}

class _AgentPurchaseScreenState extends State<AgentPurchaseScreen> {
