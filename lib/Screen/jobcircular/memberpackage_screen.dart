...
import 'package:probashi_power_project/Screen/jobcircular/Purchase_screen.dart';

import '../../Layout/main_layout.dart';
import '../../utils/color.dart';

class MemberpackageScreen extends StatefulWidget {
  const MemberpackageScreen({super.key});

  @override
  State<MemberpackageScreen> createState() => _MemberpackageScreenState();
}

class _MemberpackageScreenState extends State<MemberpackageScreen> {
  ...
  Future<void>fetchPackageList()async{
   try{
     ...
     if(responose.statusCode==200){
       ...
       setState(() {
         packageList=List<PackageListModel>.
                      ...
                      children: [
                        ...
                        ElevatedButton(onPressed: () {
                          Navigator.push(context,
                              MaterialPageRoute(
                                  builder: (context)=>MainLayout(initialScreen: 20,selectedPackage:data )));
                        },
