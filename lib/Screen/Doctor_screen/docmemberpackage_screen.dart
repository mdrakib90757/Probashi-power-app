...
class DocmemberpackageScreen extends StatefulWidget {
  const DocmemberpackageScreen({super.key});

  @override
  State<DocmemberpackageScreen> createState() => _MemberpackageScreenState();
}

class _MemberpackageScreenState extends State<DocmemberpackageScreen> {
                        ...
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                                Text("প্যাকেজ:${pack.name}",style: TextStyle(
                                    fontFamily: "NotoSansBengali",
                                    fontSize: 15,
                                    color: Colors.black,
                                    fontWeight: FontWeight.bold
                                ),),
                                Text("মূল্য:${pack.rate}",
                                  style: TextStyle(
                                      fontFamily: "NotoSansBengali",
                            ...
                            ElevatedButton(onPressed: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => MainLayout(initialScreen: 27,selectedPackage: pack,),));
                            },
