...
class DocpurchaseScreen extends StatefulWidget {
  final PackageListModel?selectPackage;
  const DocpurchaseScreen({super.key, this.selectPackage});

  @override
  State<DocpurchaseScreen> createState() => _DocpurchaseScreenState();
}

class _DocpurchaseScreenState extends State<DocpurchaseScreen> {
