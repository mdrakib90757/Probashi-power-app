...
class Aidpurchase extends StatefulWidget {
  final PackageListModel?selectPackage;
  const Aidpurchase({super.key, this.selectPackage});

  @override
  State<Aidpurchase> createState() => _AidpurchaseState();
}

class _AidpurchaseState extends State<Aidpurchase> {
  List<BankModel> BankList=[];
  List<PackageListModel>PackList=[];

  Future<PackageListModel?>fetchDobuleData()async{
    try{
